...
FiberAppGUI.OpenImage(gcf);
%Zoom in so that the fibre is easier to define (manually calling scroll)
FA.pan_zoom('z_in');FA.pan_zoom('z_in');FA.pan_zoom('z_in');
FA.pan_zoom('z_in');FA.pan_zoom('z_in');FA.pan_zoom('z_in');
FiberAppGUI.AddFiber(gcf,FA);
end
